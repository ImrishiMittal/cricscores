...
- Record runs, extras, wickets
- Track individual player statistics
- Generate scorecards and match summaries
- Configure match rules, overs, players, and team setup
...
✔ Dynamic player stats & scorecards  
✔ Designed for grassroots/local cricket  
