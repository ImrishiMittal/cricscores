...
const matchSchema = new mongoose.Schema(
  {
    ...
    innings1DataBlob: { type: mongoose.Schema.Types.Mixed, default: null },
    innings2DataBlob: { type: mongoose.Schema.Types.Mixed, default: null },
    status: {
      type: String,
...
matchSchema.index({ matchId: 1, userId: 1 }, { unique: true });
